...
class turn_based_aec_to_parallel_wrapper(
    ...
    def reset(self, seed=None, options=None):
        ...
        active_agent = self.aec_env.agent_selection # changed
        observations = {
            active_agent: self.aec_env.observe(active_agent) # changed
        }
        print(observations)
    ...
    def step(self, actions):
        ...
        print("in conversions.py")
        print(f"actions: {actions}")
        print(f"agent_selection: {self.aec_env.agent_selection}")
        print(f"what gets passed: {actions[self.aec_env.agent_selection][0][0]}")
        self.aec_env.step(actions[self.aec_env.agent_selection][0][0])
